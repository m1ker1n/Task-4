...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, L"Python Game", NULL,
      CW_USEDEFAULT, 0, 516, 739, nullptr, nullptr, hInstance, nullptr);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
	{
		curHandler_t curHandler = GetMyHandler();
		MyHandle(hWnd, curHandler, wParam);
	}
	break;
	case WM_PAINT:
	{
